...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 space-x-1">
                    ...
                    @if (auth()->user()->isEmployee())
                        <x-nav-link :href="route('documents.public')"
                                    :active="request()->routeIs('documents.public')"
                                    wire:navigate>
                            Documentos
                        </x-nav-link>
                    @endif
                    ...
                    @if (auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('documentTypes.index')"
                                    :active="request()->routeIs('documentTypes.index')"
                                    wire:navigate>
                            Tipos de doc.
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->isEmployee())
                <x-responsive-nav-link :href="route('documents.public')"
                                       :active="request()->routeIs('documents.public')"
                                       wire:navigate>
                    Documentos
                </x-responsive-nav-link>
            ...
            @if (auth()->user()->hasAnyRole(['supervisor', 'committee', 'admin']))
                <x-responsive-nav-link :href="route('documents.index')"
                                       :active="request()->routeIs('documents.index', 'documents.create', 'documents.versions')"
                                       wire:navigate>
                    Documentos
                </x-responsive-nav-link>
            @endif
            ...
            @if (auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('documentTypes.index')"
                                       :active="request()->routeIs('documentTypes.index')"
                                       wire:navigate>
                    Tipos de doc.
                </x-responsive-nav-link>
