...
return [
    ...
    #Para traducir solo los campos se usa attributes
    // 'attributes' => [
    // 'name' => 'nombre',        
    // ],

    #Configuraión personalizada
    'custom' => [
        'employee_number' => [
            'required' => 'El número de empleado es obligatorio.',
            'unique' => 'Este número de empleado ya está en uso.',
            'min' => 'El número de empledo debe ser mayor a 4 caracteres y menor a 7.',
            'max' => 'El número de empledo debe ser mayor a 4 caracteres y menor a 7.'
        ],
        'name' => [
